        ...
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white shadow-lg rounded-lg overflow-hidden border">
                ...
                <tbody class="bg-gray-100">
                    ...
                    @empty
                        <tr>
                            <td colspan="10" class="py-6 text-center text-gray-500">No appointments found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <div class="mt-4 flex justify-end">
                <button onclick="printAppointments()" class="bg-gray-600 text-white px-4 py-2 rounded-md hover:bg-gray-700 transition duration-300">Print Appointments</button>
            </div>
        ...
        <div id="printableTable" class="hidden">
            <table class="min-w-full bg-white shadow-lg rounded-lg overflow-hidden border">
                ...
                <tbody class="bg-gray-100">
                    ...
                    @empty
                        <tr>
                            <td colspan="9" class="py-6 text-center text-gray-500">No appointments found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
