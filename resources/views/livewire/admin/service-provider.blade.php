<div class="p-6 bg-white shadow-lg rounded-lg">
    ...
    <div class="mb-6 flex justify-end">
        <button onclick="printServiceProviders()" class="bg-gray-600 text-white px-4 py-2 rounded-md hover:bg-gray-700 transition duration-300">Print Service Providers</button>
    </div>
    ...
    <!-- Printable Table (Hidden) -->
    <div id="printableServiceProviders" class="hidden">
        <table class="min-w-full table-auto border-collapse">
            <thead class="bg-gray-100 text-gray-600 text-sm uppercase">
                <tr>
                    <th class="py-3 px-6 text-left border-b">Name</th>
...
<script>
    function printServiceProviders() {
        var printContents = document.getElementById('printableServiceProviders').innerHTML;
